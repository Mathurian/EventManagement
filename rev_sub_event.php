        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li>
                <a href="score_sheets.php">Results</a>
              </li>
              
            
               <li class="active">
                  <a href="rev_main_event.php"><strong>Events History</strong></a>
              </li>
...
<header class="jumbotron subhead" id="overview">
 ...
 <table class="table table-bordered">
  ...
  <td width="90">
  <a title="click to view event details" target="_blank" href="review_result.php?mainevent_id=<?php echo $mainevent_id; ?>&sub_event_id=<?php echo $subevent_row['subevent_id']; ?>" class="btn btn-success" style="min-width: 100px;">REVIEW</a>
<a target="_blank" title="click to print event result" href="review_se_result.php?mainevent_id=<?php echo $mainevent_id; ?>&sub_event_id=<?php echo $subevent_row['subevent_id']; ?>" class="btn btn-primary" style="margin-top: 10px; min-width: 100px;">RESULTS</a>
