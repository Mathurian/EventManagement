...
<header class="jumbotron subhead" id="overview">
    ...
    <br />
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="rev_main_event.php">Events History</a> / </li>
                        
                        <li>Events History: Search</li>
 ...
 <?php   
    ...
    <?php   
     ...
     <th><a title="click to view full details" href="#"><?php echo $event_row['fname']; ?> &raquo;</a></th>
