        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li class="active">
                <a href="score_sheets.php"><strong>Reports</strong></a>
              </li>
...
<header class="jumbotrontabulator subhead" id="overview">
  ...
  <div class="container">
    <h1>Reports</h1>
  <p class="lead">Event Tabulating System - Tabulator's Panel</p>
  </div>
</header>       
<?php } ?>
...
$MEidxxx=$sy_row['mainevent_id'];
     ...
     <div class="nav-collapse collapse">
     <ul class="nav">
      <strong><?php echo $s_event_row['event_name']; ?> </strong>
     ...
     <td width="70px" style="text-align:center; vertical-align:middle;">
        <a title="click to set final result for this sub-event" target="_blank" href="result_title.php?event_id=<?php echo $se_id ; ?>" class="btn btn-warning">Result</a>
     </td>

     <td width="125px" style="text-align:center; vertical-align:middle;">
        <a title="click to view special awards for this sub-event" target="_blank" href="result_awards.php?event_id=<?php echo $se_id ; ?>" class="btn btn-primary">Special Awards</a>
     </td>
